...
public class SecurityConfig {
    ...
    private static final String SUDOKU_ANIMAL_HUB_PATH = "/api/sudoku-animal-hub/**";
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(a -> a
                        .requestMatchers(HttpMethod.GET, SUDOKU_ANIMAL_HUB_PATH).permitAll()
                        .requestMatchers(HttpMethod.POST, SUDOKU_ANIMAL_HUB_PATH).authenticated()
                        .requestMatchers(HttpMethod.PUT, SUDOKU_ANIMAL_HUB_PATH).authenticated()
                        .requestMatchers(HttpMethod.DELETE, SUDOKU_ANIMAL_HUB_PATH).authenticated()
